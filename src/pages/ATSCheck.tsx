            ...
            <div className="md:col-span-1">
              <Card>
                <CardContent className="p-6 flex flex-col items-center justify-center">
                  <h2 className="text-xl font-semibold mb-6">ATS Score</h2>
                  ...
                  <Badge className={`${getScoreColor(atsScore)} text-white px-3 py-1`}>
                ...
                <CardContent>
                  ...
                  <div className="mt-6 pt-4 border-t">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="p-4 bg-accent/50 rounded-md mt-4 border border-accent">
          ...
          <Card>
            <CardContent className="p-6 flex flex-col items-center justify-center">
              <div className="animate-pulse flex flex-col items-center">
                <CheckSquare className="h-12 w-12 text-brand-purple mb-4" />
